H5P.ActiveReaderChapter = (function (EventDispatcher) {

  /**
   * Active Reader Chapter Constructor
   *
   * @class
   ...
   */
  function ActiveReaderChapter(params, id, data) {
    /** @alias h5p.ActiveReaderChapter# */
    var self = this;
    ...
    // ColActive Reader Chapterumn wrapper element
    var wrapper;

    // H5P content in the Active Reader Chapter
    var instances = [];
    ...
    var addRunnable = function (content, contentData) {
      ...
      if (ActiveReaderChapter.isTask(instance)) {
    ...
    /**
     * Creates a wrapper and the Active Reader Chapter content the first time the Active Reader Chapter
    ...
    /**
     * Attach the Active Reader Chapter to the given container
     *
    ...
    /**
     * Get title, e.g. for xAPI when Active Reader Chapter is subcontent.
     *
     * @return {string} Title.
     */
    self.getTitle = function () {
      return H5P.createTitle((self.contentData && self.contentData.metadata && self.contentData.metadata.title) ? self.contentData.metadata.title : 'ActiveReaderChapter');
    };
  ...
  ActiveReaderChapter.prototype = Object.create(EventDispatcher.prototype);
  ActiveReaderChapter.prototype.constructor = ActiveReaderChapter;
   ...
   * @return {boolean}
   */
  ActiveReaderChapter.isTask = function (instance) {
